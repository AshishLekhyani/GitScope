    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
      ...
      <section className="mb-14">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              icon: <Lock className="size-5 text-amber-400" />,
              title: "HTTPS Only",
            ...
            <div
              key={item.title}
              className="rounded-none border border-white/5 bg-[#171512]/90 p-6 backdrop-blur-xl"
            >
              <div className="mb-3 flex size-10 items-center justify-center rounded-none bg-stone-800/80">
                {item.icon}
              </div>
              <h3 className="mb-2 text-sm font-bold text-white">{item.title}</h3>
              <p className="text-xs leading-relaxed text-stone-400">{item.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-14">
        ...
        <div className="rounded-none border border-white/5 bg-[#171512]/90 p-7 backdrop-blur-xl">
      ...
      <section className="mb-14">
        ...
        <div className="rounded-none border border-amber-500/20 bg-amber-600/5 p-7 backdrop-blur-xl">
          ...
          <ol className="mb-6 space-y-3">
            {[
              ...
              <li key={i} className="flex items-start gap-3 text-sm text-stone-400">
                <span className="flex size-5 shrink-0 items-center justify-center rounded-full bg-amber-500/20 text-[10px] font-bold text-amber-400">
                  {i + 1}
                </span>
                {step}
              </li>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-none bg-amber-600 px-5 py-2.5 text-sm font-bold text-white transition hover:bg-amber-500"
          >
      ...
      <section className="mb-14">
        ...
        <div className="rounded-none border border-white/5 bg-stone-900/40 p-7 backdrop-blur-xl">
      ...
      <section>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="rounded-none border border-white/5 bg-[#171512]/90 p-6 backdrop-blur-xl">
