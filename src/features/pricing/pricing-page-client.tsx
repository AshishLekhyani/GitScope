        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "Who pays for the GitHub API calls?", a: "Each GitHub OAuth user uses their own personal rate limit — we never pool tokens. GitScope pays for AI (Anthropic) usage and hosting. Your GitHub calls are yours." },
              ...
              { q: "How does the AI analysis work?", a: "We use Anthropic's Claude to analyze your repository context (recent commits, PR data) and score risk. Each analysis costs approximately $0.01–0.05 in AI API usage, covered by your plan." },
            ].map((faq) => (
