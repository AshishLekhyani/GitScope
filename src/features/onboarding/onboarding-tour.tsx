...
const STEPS: Step[] = [
  {
    ...
    body: "Your engineering intelligence dashboard — AI-powered repo health scans, CVE detection, PR reviews, DORA metrics, and team dashboards all in one place.",
    bullets: ["Analyze any public or private GitHub repo", "BYOK is free — use Anthropic, OpenAI, Groq, Gemini, Cerebras & more", "Free plan is generous — upgrade to Developer for unlimited everything"],
  ...
  },
  {
    ...
    accentClass: "text-amber-400",
    accentBg: "bg-amber-500/10 border-amber-500/25",
    title: "Bring Your Own AI Keys — Free Forever",
    body: "BYOK is 100% free on every plan. Paste your own API key from any provider and run unlimited AI scans at zero cost to GitScope — you just pay your provider directly.",
    bullets: [
      "Settings → Integrations → AI Provider API Keys",
      "Anthropic Claude, OpenAI GPT-4o, Gemini, Groq, Cerebras — all supported",
      "Groq & Cerebras are free-tier friendly with generous limits",
      "BYOK also unlocks private repo analysis on the Free plan",
    ],
    primaryCta: "Next",
  ...
  },
  {
    ...
    body: "Get scan results, CVE alerts, and weekly digests delivered to your team's Slack or Discord channel. Available on the Developer plan.",
    bullets: [
